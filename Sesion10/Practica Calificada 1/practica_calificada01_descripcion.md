...
Puedes realizarla de forma **individual o grupal**. Si es grupal, indica los **nombres de todos los integrantes** dentro del informe PDF.

## Entregables

- Informe único `PC1_Apellido_Nombre.pdf` con la estructura de la sección 5 del enunciado.
- Mapa conceptual editable `PC1_Apellido_Nombre_mapa_conceptual.canvas`.

Calificación sobre **20 puntos** según los criterios de la sección 6.
