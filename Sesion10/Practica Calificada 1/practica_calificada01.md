...
En Windows puedes usar WSL como terminal cliente y documentar su versión, si lo utilizas. La VM Ubuntu en modo puente sigue siendo el servidor del caso. En macOS o Linux utiliza la terminal del sistema. Explica esta elección con lo visto en la sesión 10.
